clear all; clc
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Absolute error between estimated PLV and simulated PLV  %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
plot_layer5      = 1;
plot_three_part  = 1;
save_figure_path = fullfile("C:\Users\Snowp\Desktop\paperFigures", "figure3d-1.tif");
%% 1. Load data
folderPath = "C:\Users\Snowp\PycharmProjects\pythonProject\24_tACS_PLV\data_paper\data_matlab";
fileName   = "L5SOI_abosolute_error_of_estimated_PLV_smooth.mat";
