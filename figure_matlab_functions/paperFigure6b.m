...
save_figure_path = fullfile("C:\Users\Snowp\Desktop\paperFigures", "figure6b-1.tif");
fileName   = "L5SOI_PPh_nonUniformEF_smooth.mat";
dataPath   = fullfile(folderPath, fileName);
data          = load(dataPath);
...
save_figure_path = fullfile("C:\Users\Snowp\Desktop\paperFigures", "figure6b-2.tif");
fileName   = "L5SOI_abosolute_error_of_PPh_between_uniform_and_nonUniform_smooth.mat";
dataPath   = fullfile(folderPath, fileName);
data          = load(dataPath);
layer_surface = data.surface;
list_color    = data.list_color;
...
save_figure_path = fullfile("C:\Users\Snowp\Desktop\paperFigures", "figure6b-3.tif");
fileName   = "L5SOI_relative_error_of_PPh_between_uniform_and_nonUniform_smooth.mat";
dataPath   = fullfile(folderPath, fileName);
data          = load(dataPath);
layer_surface = data.surface;
list_color    = data.list_color;
