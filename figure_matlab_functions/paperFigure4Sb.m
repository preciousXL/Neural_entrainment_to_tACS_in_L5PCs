clear all; clc
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% EF tangential distribution in layer 5 SOI %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
plot_layer5      = 1;
plot_three_part  = 0;
save_figure_path = fullfile("C:\Users\Snowp\Desktop\paperFigures", "figure4Sb-1.tif");
%% 1. Load data
folderPath = "C:\Users\Snowp\PycharmProjects\pythonProject\24_tACS_PLV\data_paper\data_matlab";
fileName   = "L5SOI_EF_tangential_component_smooth.mat";
