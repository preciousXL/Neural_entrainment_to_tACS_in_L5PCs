clear all; clc
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Effective polarization length Lp in L5SOI %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
plot_layer5      = 1;
plot_three_part  = 0;
save_figure_path = fullfile("C:\Users\Snowp\Desktop\paperFigures", "figure4e-1.tif");
%% 1. Load data
folderPath = "C:\Users\Snowp\PycharmProjects\pythonProject\24_tACS_PLV\data_paper\data_matlab";
fileName   = "L5SOI_effecctive_polarization_length_L5PCClone4_smooth.mat";
...
%% 3. Plot figures
if plot_layer5
    fig = figure('Units', 'centimeters', 'Position', [30, 10, 7, 6.2]);
